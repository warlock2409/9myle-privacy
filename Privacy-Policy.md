...
- Email address
- Phone number
- Business or gym details (for business users)
...
- Trusted third-party services used for app functionality (analytics, hosting, notifications)
...
We take reasonable technical and organizational measures to safeguard your data.  
...
Any changes will be posted in this document with an updated date.
